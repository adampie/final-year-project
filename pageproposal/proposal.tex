...
\\\\
The final deliverable for this project is a codebase that utilizes Ansible to generate the Raspbian images.      
\\\\
...
\begin{itemize}
  ...
  \item LISA - \url{https://www.usenix.org/conference/lisa16}
\end{itemize}
}
\end{document}
